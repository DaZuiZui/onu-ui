...
3. Use `pnpm run dev` to start project, `pnpm run play` to start the playground, and `pnpm run docs` to write docs. Usually a dev server and document server can be debugged.
